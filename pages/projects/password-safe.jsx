      ...
      <div className={styles.images}>
        <div className={styles.imageContainer}>
          <div className={styles.imageHolder}>
            <img src="/images/gamedev.jpg" alt="project" />
          </div>
          <div className={styles.imageHolder}>
            <img src="/images/webdev.jpg" alt="project" />
          </div>
          <div className={styles.imageHolder}>
            <img src="/images/gamedev.jpg" alt="project" />
          </div>
